...
$query = "INSERT INTO projects (project_name, images, status) VALUES ('$name','$image', 'active')";
...
?>
    <div class="card">
        <div class="card-header">
            <h5>Add New Project</h5> </div>
        <div class="card-block">
            <form method="post" action="" enctype="multipart/form-data">
                <div class="row">
                <div class="col-sm-12 col-xl-6 m-b-30">
                    <p class="fee-bold">Project Name</p>
                    <input type="text" class="form-control fill" name="project_name" required>
                </div>
                    <div class="col-sm-12 col-xl-6  m-b-30">
...
include("connection.php");
$i = 0;
$query = "SELECT * FROM projects WHERE status = 'active' ORDER BY id DESC";  
$result = mysqli_query($conn, $query);
if (mysqli_num_rows($result)) 
{ ?>   <form action="delete-all-project.php" method="post" >    
        <div class="card">
            <div class="card-header">
                            ...
                            while($row = mysqli_fetch_array($result)) 
                                 {
                                    echo '
                                         <tr>
                                            ...
                                            <td><img src="images/project/'.($row["images"]).'"  alt="" class="user-img img-radius" width="40px" height="40px"></td>
                                                                                        
                                            <td><div class="btn-group-sm" style="float: none;"> 
                                            <a href="edit-project.php?id='. ($row["id"]).'" class="tabledit-edit-button btn btn-primary waves-effect waves-light" style="float: none;"><span class="icofont icofont-ui-edit"></span></a>
                                            
                                            <a href="delete-project.php?id='.($row["id"]).'" class="tabledit-delete-button btn btn-danger waves-effect waves-light" style="float: none;margin: 5px;" onclick="return checkDelete()"><span class="icofont icofont-ui-delete"></span></a> </div></td>
                                         </tr>';
                                }
