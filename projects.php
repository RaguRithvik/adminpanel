        ...
        <section class="cases-section cases-page">
            <div class="auto-container">
                ...
                <div class="row clearfix">
                    <?php
                        ...
                        $sql = "SELECT * FROM projects where status ='active' ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";
                        ...
                        <div class="case-block col-md-4 col-sm-6 col-xs-12">
                            <div class="inner-box">
                                <div class="image"> <img src="admin/images/project/<?php echo $row["images"] ?>" width="500px" height="333px" alt="" />
                                    <div class="overlay-box">
                                        <div class="content"> <a class="lightbox-image" href="admin/images/project/<?php echo $row["images"] ?>" data-fancybox-group="gallery"><span class="icon fa fa-search"></span></a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <ul class="pagination">
                    <br>
                    <?php 
                             $sqls = "SELECT * FROM projects where status='active'";   
